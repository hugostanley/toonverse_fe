          ...
          <CTableHead>
            ...
            {data && data.map((artist) => (
              <CTableRow key={artist.id} className=''>
                <CTableHeaderCell scope="row" className='tracking-widest pt-3'>{artist.workforce_id}</CTableHeaderCell>
                <CTableDataCell className='pt-3'>{artist.email}</CTableDataCell>
                <CTableDataCell className='pt-3'>{artist.last_name}</CTableDataCell>
                <CTableDataCell className='pt-3'>{artist.first_name}</CTableDataCell>
                <CTableDataCell className='pt-3'>{artist.billing_address}</CTableDataCell>
                <CTableDataCell className='pt-3'>{artist.mobile_number}</CTableDataCell>
                <CTableDataCell className='pt-3'>{artist.total_earnings}</CTableDataCell>
                <CTableDataCell>
