  ...
  return (
    <main className="relative w-full h-full flex flex-col justify-center items-center bg-pink z-0">
      <div className="z-20 bg-ivory/45 backdrop-blur-md border-4 border-dark rounded-2xl shadow-2xl w-full max-w-[480px] h-fit flex flex-col gap-3 py-8 px-14">
        ...
        <h1 className="text-5xl tracking-widest font-black px-2">Sign in</h1>
        ...
        >
          <small>No account yet? Register</small>
        </Link>
      ...
      <svg
        ...
        className="fixed -top-20 left-0 z-0 rotate-180"
      >
        <path
          fill="#fadaf6"
          fillOpacity="1"
          d="M0,0L48,37.3C96,75,192,149,288,165.3C384,181,480,139,576,149.3C672,160,768,224,864,229.3C960,235,1056,181,1152,165.3C1248,149,1344,171,1392,181.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
        ></path>
      </svg>
